                ...
                <div class="col-lg-12">
                     <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="<?php echo base_url('admin/proses/tambah_owner'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
...
<script>
    $("#outlet").change(function(){
        ...
        $.ajax({
            url : "<?php echo base_url();?>/admin/proses/tambah_owner",
            method : "POST",
            data : {id : id_outlet},
            async : false,
