  ...
  <div class="navbar-header">
             ...
             <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li>
                  ...
                  <!--   </li>
                  <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-list"></i> Data Cucian</a>
                        
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa  fa-mail-forward"></i><a href="<?php echo base_url('aset/forms-basic.html');?>">Baru Masuk</a></li>
                            <li><i class="menu-icon fa  fa-check-square-o"></i><a href="<?php echo base_url('aset/forms-advanced.html');?>">Sudah Dibayar</a></li>
                            <li><i class="menu-icon fa  fa-times"></i><a href="<?php echo base_url('aset/forms-advanced.html');?>">Belum Dibayar</a></li>
                        </ul>
                    </li>  -->
                    <li>
