             ...
             <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li>
                 ...
                 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon ti-themify-logo"></i><a href="<?php echo base_url('aset/font-themify.html');?>">Themefy Icons</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="<?php echo base_url('aset/charts-chartjs.html');?>">Chart JS</a></li>
                            <li><i class="menu-icon fa fa-area-chart"></i><a href="<?php echo base_url('aset/charts-flot.html');?>">Flot Chart</a></li>
                            <li><i class="menu-icon fa fa-pie-chart"></i><a href="<?php echo base_url('aset/charts-peity.html');?>">Peity Chart</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-map-o"></i><a href="<?php echo base_url('aset/maps-gmap.html');?>">Google Maps</a></li>
                            <li><i class="menu-icon fa fa-street-view"></i><a href="<?php echo base_url('aset/maps-vector.html');?>">Vector Maps</a></li>
                        </ul>
                    </li>-->
