<script src="<?php echo base_url('aset/vendors/jquery/dist/jquery.min.js');?>"></script>
   ...
   <script src="<?php echo base_url('aset/vendors/datatables.net/js/jquery.dataTables.min.js')?>"></script>
    <script src="<?php echo base_url('aset/vendors/datatables.net-bs4/js/dataTables.bootstrap4.min.js');?>"></script>
    <script src="<?php echo base_url('aset/vendors/datatables.net-buttons/js/dataTables.buttons.min.js');?>"></script>
    <script src="<?php echo base_url('aset/vendors/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js');?>"></script>
    <script src="<?php echo base_url('aset/vendors/jszip/dist/jszip.min.js');?>"></script>
    <script src="<?php echo base_url('aset/vendors/pdfmake/build/pdfmake.min.js');?>"></script>
    <script src="<?php echo base_url('aset/vendors/pdfmake/build/vfs_fonts.js');?>"></script>
