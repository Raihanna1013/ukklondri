                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Main/Data Member/Edit Member</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                     <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="<?php echo base_url('admin/proses/edit_member'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
