                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="<?=base_url('kasir/Dashboard/tambah_member');?>" class="btn btn-primary "><i class='fa fa-plus'> Tambah member</i> </a> 
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                  ...
                                  <tbody align='center'>
                                    <?php if(count($member)) :?>
                                        ...
                                        <td>                                             
                                                <a href="<?php echo base_url('kasir/dashboard/edit_member/'. $data_member->id); ?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
